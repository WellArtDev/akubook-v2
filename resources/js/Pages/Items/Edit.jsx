...
export default function Edit({ auth, item, options }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        valuation_method: item.valuation_method || 'moving_average',
        unit: item.unit || 'pcs',
                ...
                <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <Link href={route('items.show', item.id)} className="bg-gray-600 text-white px-4 py-2 rounded">Back</Link>
                        </div>

...
export default function Create({ auth, suppliers, branches, items }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        notes: '',
        lines: [
            { item_id: '', description: '', quantity: 1, unit: '', unit_price: 0, tax_amount: 0 },
        ],
    });
    ...
    const updateLine = (index, field, value) => {
        ...
        // Auto-fill unit and price when item selected
        if (field === 'item_id') {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Tambah Purchase Order</h2>}
        >
                                                ...
                                                <tr key={index}>
                                                    <td className="px-3 py-2">
                                                        ...
                                                        {errors[`lines.${index}.item_id`] && (
                                                            <p className="text-xs text-red-600">{errors[`lines.${index}.item_id`]}</p>
                                                        )}
                                                    </td>
                                                    <td className="px-3 py-2">
                                                        <input

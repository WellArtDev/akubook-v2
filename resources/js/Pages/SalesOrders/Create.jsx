...
export default function Create({ auth, customers, branches, items }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        notes: '',
        lines: [
            { item_id: '', description: '', quantity: 1, unit: '', unit_price: 0, discount_percent: 0, discount_amount: 0, tax_amount: 0 },
        ],
    });
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Tambah Sales Order</h2>}
        >
            <Head title="Tambah Sales Order" />
